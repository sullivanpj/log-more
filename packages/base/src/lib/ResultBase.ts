import { DefaultLogMoreConfigBase } from "./constants";
...
export class ResultBase extends Error {
   ...
   */
  public readonly instanceId?: string = LOG_MORE_GLOBAL_RESULT_INSTANCE_ID;

  constructor(message?: string) {
    super(message ?? DefaultLogMoreConfigBase.message);
